function __InputConfigVerbs()
{
    ...
    if (not INPUT_ON_SWITCH)
    {
        ...
        InputDefineVerb(INPUT_VERB.ATTACK,  "attack",      vk_space,            gp_face1);
        InputDefineVerb(INPUT_VERB.SPRINT,  "sprint",      vk_shift,            gp_face2);
        InputDefineVerb(INPUT_VERB.ACTION,  "action",     "E",                  gp_face3);
        InputDefineVerb(INPUT_VERB.DIALOG, "dialog",      "E",                  gp_face4);
